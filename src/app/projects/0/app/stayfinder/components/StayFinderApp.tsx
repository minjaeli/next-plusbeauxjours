...
const StayFinderApp: React.FunctionComponent<any> = () => {
  const ScreenShots = () => {
  ...
  return (
    <div className="bg-gray-100 mb-72">
      ...
      <div className="flex flex-col justify-center items-center mb-24">
        ...
        />
        <Image
          src={"/images/app/stayfinder/stayfinder_map_to_data_code_1.png"}
          width={900}
          height={1200}
        ...
        />
        <Image
          src={"/images/app/stayfinder/stayfinder_map_to_data_code_2.png"}
          width={900}
          height={1200}
      ...
      <div className="flex flex-col justify-center items-center mb-24">
        ...
        />
        <Image
          src={"/images/app/stayfinder/stayfinder_data_to_map_code.png"}
          width={900}
          height={1200}
