  ...
  return (
    <div className="bg-gray-100 mb-72">
      ...
      <div className="my-24 flex flex-col justify-center items-center">
        ...
        />
        <Image
          src={"/images/app/pinner/pinner_search_autocomplete_code.png"}
      ...
      <div className="my-24 flex flex-col justify-center items-center">
        ...
        />
        <Image
          src={"/images/app/pinner/pinner_create_city_code_1.png"}
          className="max-w-full mt-24 mb-1"
          width={900}
          height={1200}
          alt=""
        />
        <Image
          src={"/images/app/pinner/pinner_create_city_code_2.png"}
        ...
        />
        <Image
          src={"/images/app/pinner/pinner_create_city_code_3.png"}
